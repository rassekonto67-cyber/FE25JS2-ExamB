...
- [x] Appen har minst 3 routes/views, Home-sidan, About-sidan och Clothes-sidan.
- [x] Appen använder sig av React Routers inbyggda Link för navigationen.
  
(B) Komponentsstruktur + Props

- [x] Jag har flera återanvändbara komponenter såsom Filter, Sorting och ProductCard där kläderna visas på sidan.
- [x] Jag använder props till dessa.
  
(C) State + Interaktivitet (useState)

- [x] Jag använder useState för filtreringen och sorteringen av kläderna.
  
(D) Data + API (useEffect + ex: fetch)

- [x] Appen hämtar data från ett API med fetch i useEffect.
- [x] Appen har både loading state och felhantering.
- [x] API datan hämtas och visas i gränssnittet.
...
- [x] Jag gjorde en extra detail view när man klickar på själva produkten, så ser man beskrivningen för plagget.
- [x] Jag använder även mig utav useParams för att få rätt id till kläderna på produkt sidan där man ser beskrivning (detaljerade vyn).
  
"Och minst 1 av dessa:"

- [x] Appen har en sorteringsfunktion (UI-funktion)
